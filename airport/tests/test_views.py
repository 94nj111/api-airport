...
class ViewSetTests(APITestCase):
    def setUp(self):
        ...
        self.airport1 = Airport.objects.create(name="Heathrow", closest_big_city="London")
        self.airport2 = Airport.objects.create(name="Charles de Gaulle", closest_big_city="Paris")
    ...
    def test_airplane_type_list(self):
        ...
        response = self.client.get("/api/airport/airplane-types/")
        self.assertEqual(response.status_code, status.HTTP_200_OK)

    def test_airplane_type_create_admin_only(self):
        self.authenticate(self.user)
        response = self.client.post("/api/airport/airplane-types/", {"name": "Airbus A320"})
    ...
    def test_airplane_list(self):
        self.authenticate(self.user)
        response = self.client.get("/api/airport/airplanes/")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_airplane_create_admin_only(self):
        ...
        self.authenticate(self.user)
        response = self.client.post("/api/airport/airplanes/", data)
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
    ...
    def test_airport_create_admin_only(self):
        ...
        self.authenticate(self.user)
        response = self.client.post("/api/airport/airports/", data)
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
    ...
    def test_route_list(self):
        self.authenticate(self.user)
        response = self.client.get("/api/airport/routes/")
        self.assertEqual(response.status_code, status.HTTP_200_OK)

    def test_route_create_admin_only(self):
        data = {"source": self.airport1.id, "destination": self.airport2.id, "distance": 500}
        self.authenticate(self.user)
        response = self.client.post("/api/airport/routes/", data)
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
    ...
    def test_flight_list(self):
        self.authenticate(self.user)
        response = self.client.get("/api/airport/flights/")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_flight_create_admin_only(self):
        ...
        self.authenticate(self.user)
        response = self.client.post("/api/airport/flights/", data)
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
    ...
    def test_order_list_user_only(self):
        self.authenticate(self.user)
        response = self.client.get("/api/airport/orders/")
        self.assertEqual(response.status_code, status.HTTP_200_OK)

    def test_order_create_unauthenticated(self):
        response = self.client.post("/api/airport/orders/", {"tickets": []})
